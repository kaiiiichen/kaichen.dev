...
<div className="mb-8">
  ...
  <p style={{ fontFamily: "'Nunito'", fontWeight: 400, fontSize: 16, lineHeight: 1.65 }} className="text-zinc-500 dark:text-zinc-400 mt-3 max-w-[52rem]">A complete reference for Scheme's four quoting forms — how they work, when to use them, and the classic pitfall with <code>(car '(list ...))</code>.</p>
